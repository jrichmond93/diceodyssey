...
export function GalaxyBoard({
  ...
  return (
    <div className="rounded-xl border border-slate-700 bg-slate-950/70 p-4">
      ...
      <p className="mb-3 text-xs text-slate-400">Start is position 0. P# is the planet index. Chips show ships on that planet. Unknown/barren/event/macguffin icons show planet state. Faces 5/6 are reward planets. Claimed means rewards already harvested.</p>
